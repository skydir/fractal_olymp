...
<body class="bd">
	...
	<div id="centeredmenu">
		<ul>
			...
			<li><a href="student_vse_olymp.php">Назад</a></li>
			<li><a href="student_vse_olymp_results.php" class="active">Рейтинг по олимпиаде "<?=$_SESSION['Nazv']?>"</a></li>
			...
			<table class="StandardTable" align="center" border="1"> 
				...
				?> 
					<tr>
						...
						<td class="pocentru"><p><?=$row2['Class']?></p></td>						
