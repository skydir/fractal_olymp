<?php 
	...
	$q=$_SESSION['KodStud'];
	$strSQL = "SELECT * FROM `Stud` where `KodStud`='$q'";
...
<script>
	...
	function Sel_Change()
	{
		...
		xmlhttp.open('POST', 'stud_save.php', true); // Открываем асинхронное соединение
...
<body class="bd">
	...
	<div id="centeredmenu">
		<ul>
			...
			<li><a href="admin_students_red.php" class="active">Редактирование ученика</a></li>
			...
			<div class="vnutri_forma_vvoda">
				<table id="tbl">
					...
					<tr>
						...
						<td>
							<input class="pole_vvoda2" id="class1" type="text" name="class1" value='<?=$row['Class']?>' />
							<div  class="text_near_knopka5" id="d4"></div>
						</td>
					</tr>
					<tr>
						<td align="right" valign="top">							
							<p class="text_near_knopka3">Место обучения: </p>
						</td>
						<td>
							<input class="pole_vvoda2" id="mesto1" type="text" name="mesto1" value='<?=$row['Mesto']?>' />
							<div  class="text_near_knopka5" id="d4"></div>
						</td>
					</tr>
					<tr>
