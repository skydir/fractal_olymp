...
/* 		if(!fio1.match(/^[А-ЯЁ]{1}[А-ЯЁа-яё ]{0,65535}$/))
		{
			var dfio1 = document.createElement("dfio1");
			dsurname1.innerHTML = "Фамилия должна иметь длину 1-65535 символов и начинаться с заглавной буквы.Допускается ввод букв русского алфавита."; 
			document.getElementById("d2").appendChild(dsurname1); 	
			if_good=false;
		}	 */
	/* 	if(!name1.match(/^[А-ЯЁ]{1}[А-ЯЁа-яё]{0,254}$/))
		{
			var dname1 = document.createElement("dname1");
			dname1.innerHTML = "Имя должно иметь длину 1-255 символов и начинаться с заглавной буквы.Допускается ввод букв русского алфавита."; 
			document.getElementById("d3").appendChild(dname1);
			if_good=false;
		}	
		if(!patronymic1.match(/^[А-ЯЁ]{1}[А-ЯЁа-яё]{0,254}$/))
		{
			var dpatronymic1 = document.createElement("dpatronymic1");
			dpatronymic1.innerHTML = "Отчество должно иметь длину 1-255 символов и начинаться с заглавной буквы.Допускается ввод букв русского алфавита."; 
			document.getElementById("d4").appendChild(dpatronymic1); 
			if_good=false;			
		} */	
...
<body class="bd">
	...
	<div id="centeredmenu">
		<ul>
			...
			<li><a href="admin_prepodavateli_insert.php" class="active">Добавление нового преподавателя</a></li>
			...
			<div class="vnutri_forma_vvoda">
				<table id="tbl">
					...
					<tr>
						...
						<td>
							<textarea class="pole_vvoda2" id="info1" rows="2" ></textarea>
