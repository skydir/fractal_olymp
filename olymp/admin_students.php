...
<script>
	function del()
	{
		...
		xmlhttp.open('POST', 'stud_del.php', true); // Открываем асинхронное соединение
	...
	function perehod()
	{
		...
		//alert("Value: " + value + "\nТекст: " + text); // Вывод алерта для проверки значений
		var xmlhttp = getXmlHttp(); // Создаём объект XMLHTTP
		xmlhttp.open('POST', 'change9.php', true); // Открываем асинхронное соединение
		xmlhttp.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded'); // Отправляем кодировку
		var str='xKodStud='+encodeURIComponent(value)+
		...
		document.location.href = 'admin_students_red.php';
	}
	function getXmlHttp() 
	{
		var xmlhttp;
...
<body class="bd">
	...
	<div id="centeredmenu">
		<ul>
			...
			<li><a href="admin_prepodavateli.php">Преподаватели</a></li>
			<li><a href="admin_students.php" class="active">Ученики</a></li>
	...
	<div id="div2" align="center"> 
		<input class="knopka" id="b_insert" type="button" value="Добавить нового ученика" onclick="location.href='admin_students_insert.php'" />
		<input class="knopka" id="b_change" type="button" value="Редактировать ученика" onclick="perehod()" />
		<input class="knopka" id="b_delete" type="button" value="Удалить ученика" onclick="del()" />
	</div>
	<br>
	<div id="div1">
			<?php 
